...
const { authMiddleware, isAdmin, sellerAuthMiddleware } = require('../Middlewares/Middleware')
const { uploadPhoto, productImgResize } = require('../Middlewares/uploadimages')
const router = express.Router();

router.post('/createProduct', authMiddleware, isAdmin, createProduct)
router.put("/upload/:id", sellerAuthMiddleware, isAdmin, uploadPhoto.array('images', 10), productImgResize, uploadImages)
